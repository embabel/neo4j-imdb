...
public class Importer implements Runnable {
    ...
    public void runCypher() throws IOException {
        var cypher = new DefaultResourceLoader()
                .getResource("cypher/addLabels.cypher").getContentAsString(Charset.defaultCharset());
        repository.query(cypher);
    }
}
